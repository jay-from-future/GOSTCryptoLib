...
public class PBKDF2WithStribogTest {
    ...
    public void hashPasswordTest() throws Exception {
        ...
        byte[] actualHashPassword = hashPassword("PASSWORD", "SALT", ITERATIONS, KEY_LENGTH);
    ...
    public void hashForTwoDifferentPasswordsTest() throws Exception {
        ...
        byte[] actualHashPassword1 = hashPassword(password1, "SALT", ITERATIONS, KEY_LENGTH);
        byte[] actualHashPassword2 = hashPassword(password2, "SALT", ITERATIONS, KEY_LENGTH);
